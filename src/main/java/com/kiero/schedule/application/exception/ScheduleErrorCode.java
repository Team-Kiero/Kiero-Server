...
public enum ScheduleErrorCode implements BaseCode {
	...
	REQUIRED_PARAMS_FOR_RECURRING_SCHEDULE(HttpStatus.BAD_REQUEST, "반복일정을 삭제할 경우, 바디에 isIncludeFollowing, 쿼리 파라미터에 startDate, endDate를 포함해야 합니다."),
	REQUIRED_PARAMS_FOR_NORMAL_SCHEDULE(HttpStatus.BAD_REQUEST, "단일일정을 삭제할 경우, 쿼리 파라미터에 selectedDate를 포함해야 합니다."),
