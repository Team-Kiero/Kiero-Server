...
public class ParentController {
	...
	public ResponseEntity<SuccessResponse<ParentLoginResponse>> login(
		...
		ParentLoginResponse response = parentLoginUseCase.loginWithAuthorizationCode(authorizationCode, request);
	...
	public ResponseEntity<SuccessResponse<InviteCodeCreateResponse>> invite(
		...
		return ResponseEntity
			...
			.body(SuccessResponse.of(ParentSuccessCode.INVITE_CODE_CREATED, response));
	}
